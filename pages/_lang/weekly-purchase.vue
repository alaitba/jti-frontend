		...
		data(){
			return{
				...
				calendarConfigs: {
	                ...
	                monthNames: ["Январь/Қаңтар", "Февраль/Ақпан", "Март/Наурыз", "Апрель/Сәуір", "Май/Мамыр", "Июнь/Маусым", "Июль/Шілде", "Август/Тамыз", "Сентябрь/Қыркүйек", "Октябрь/Қазан", "Ноябрь/Қараша", "Декабрь/Желтоқсан"],
