		...
		methods:{
			...
			sendFeedback(){
				...
				try{
					...
					this.title = this.$t('Сообщение отправлено!')

					this.text = this.$t('Спасибо за вашу обратную связь, как только администратор ответит на ваш вопрос, вы получите уведомление')
					...
					this.title = this.$t('Сообщение нет отправлено!')

					this.text = this.$t('Попробуйте позже')
