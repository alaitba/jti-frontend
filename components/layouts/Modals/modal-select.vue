      ...
      <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">                          
          ...
          <div class="modal-body">
              ...
              <div class="body">
                <div class="days">
                  <div :class="{'days__item': true, 'active': checkArrayData('Пн')}">
                  ...
                  <div :class="{'days__item': true, 'active': checkArrayData('Вт')}">
                    <label class="checkbox-container">
                      Вторник
                  ...
                  <div :class="{'days__item': true, 'active': checkArrayData('Ср')}">
                    <label class="checkbox-container">
                      Среда
                  ...
                  <div :class="{'days__item': true, 'active': checkArrayData('Чт')}">
                    <label class="checkbox-container">
                      Четверг
                  ...
                  <div :class="{'days__item': true, 'active': checkArrayData('Пт')}">
                    <label class="checkbox-container">
                      Пятница
